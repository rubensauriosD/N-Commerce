namespace Aplicacion.Constantes
{
    ...
    {
        public void ComoTelefono(Control control, bool obligatorio = false)
        {
            if (control is TextBox)
                ConfigurarProiedadesTelefono(control as TextBox);

            Validador validador = (string txt, out string errMjs) =>
            {
                errMjs = "El campo debe contener hasta 40 carácteres numéricos.";
        ...
        private void ConfigurarProiedadesTelefono(TextBox textBox)
        {
